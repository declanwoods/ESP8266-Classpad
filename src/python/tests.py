...
assert obj.writeString("88888888") == "3A 4E 44 64 00 01 00 01 00 0E 00 0E 05 7F 68 3A 00 01 38 38 38 38 38 38 38 38 00 00 00 00 3F".replace(" ", "")
# assert obj.writeString("") == "3A 4E 44 64 00 01 00 01 00 0E 00 0E 05 7F 68 3A 00 01 31 32 33 34 35 36 37 38 00 00 00 00 5B".replace(" ", "")
